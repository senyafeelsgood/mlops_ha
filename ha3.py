...
def create_dag(dag_id: str, model_name: Literal["gradient_boosting", "logistic_regression", "decision_tree"]):
    ...
    def init(model_name: str) -> Dict[str, Any]:
        ...
        # Используйте свои ФИ для имени эксперимента
        experiment_name = "Arsenii_Korol"  # Имя эксперимента на основе ваших ФИ
        experiment_id = mlflow.create_experiment(experiment_name)  # Создание или получение эксперимента
